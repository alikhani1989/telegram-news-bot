...
function buildPrompt(recentMessages, recentTitlesPrompt) {
  ...
  p.push("تیتر خوب: ✴️ به احترام اربعین سکوت کرده‌ایم");
  p.push("تیتر بد: ❌ نیکزاد گفت: بنزین گران نمی‌شود");
  p.push("تیتر بد: ❌ قالیباف: تنگه هرمز...");
  p.push("");
  ...
  p.push("- حتماً نام + سمّت دقیق شخص + منبع در خط اول متن باشد");
  p.push("  مثال: عبدالجلال ایری عضو کمیسیون شوراها و امور داخلی مجلس گفت که...");
  p.push("- سمّت افراد باید دقیقاً از متن اصلی کپی شود. هرگز حدس نزنید.");
  ...
  p.push("- حتماً نکته اصلی و مهم خبر را بیان کنید");
  p.push("");
