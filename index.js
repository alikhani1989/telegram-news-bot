...
function buildPrompt(recentMessages, recentTitlesPrompt) {
  ...
  p.push("=== قوانین متن ===");
  p.push("- با 🔸 شروع شود");
  p.push("- ۱ تا ۲ بند کوتاه باشد (نه فقط یک جمله)");
  ...
  p.push('خروجی: {"news":[{"title":"✴️ تیتر","body":"🔸 متن خبر در ۱ تا ۲ بند","source_link":"لینک منبع","image_url":"لینک تصویر یا خالی"}]}');
  p.push("");
  ...
  p.push('بدن: فداحسین مالکی عضو کمیسیون امنیت ملی و سیاست خارجی مجلس در مصاحبه با خبرگزاری دانشجو گفت که در حال حاضر ایران و عمان بر روی مسیر پیشنهادی ایران تمرکز کرده‌اند و مذاکرات در این زمینه در آستانه نهایی‌شدن قرار دارد.');
  p.push("");
  ...
  p.push('بدن: علی نیکزاد نایب‌رئیس مجلس در پاسخ به تذکری درباره افزایش قیمت بنزین گفت که روز گذشته جلسه‌ای با پورمحمدی، رئیس سازمان برنامه و بودجه، داشتیم.');
  p.push("");
  ...
  p.push('بدن: حسن قشقاوی سخنگوی کمیسیون امنیت ملی و سیاست خارجی مجلس در صفحه شخصی خود نوشته که در رسانه‌ها از تشدید تنش سخن می‌گویند، در حالیکه از طریق کانال‌های موجود، خواهان مذاکره هستند.');
  p.push("");
  p.push('آن‌ها نمی‌توانند جمهوری اسلامی ایران را فریب دهند. ترتیبات ایرانی برای عبور از تنگه هرمز تنها گزینه روی میز است.');
  p.push("");
  
  p.push("نمونه ۴ (با جزئیات و ارقام مهم): ");
  p.push('تیتر: ✴️ ممنوعیت واردات لوازم خانگی در آستانه لغو');
  p.push('بدن: حاکم ممکان، عضو کمیسیون اقتصادی در مصاحبه با ایسنا با انتقاد از عمل نکردن تولیدکنندگان لوازم خانگی به تعهدات خود گفت که اگر مشخص شود واردات یک میلیارد و ۲۰۰ میلیون دلار قطعات مورد نیاز از مسیرهای ملوانی و کولبری انجام نمی‌شود، احتمال لغو ممنوعیت واردات و صدور مجوز واردات چهار قلم لوازم خانگی تا سقف ۵۰۰ تا ۶۰۰ میلیون دلار وجود دارد.');
  p.push("");
