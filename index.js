...
function buildPrompt(recentMessages, recentTitlesPrompt) {
  ...
  // قوانین متن
  p.push("=== قوانین متن ===");
  p.push("- دقیقاً ۲ بند کوتاه باشد");
  ...
  p.push('بدن:');
  p.push('🔸 حاکم ممکان، عضو کمیسیون اقتصادی در مصاحبه با ایسنا با انتقاد از عمل نکردن تولیدکنندگان لوازم خانگی به تعهدات خود گفت که اگر مشخص شود واردات یک میلیارد و ۲۰۰ میلیون دلار قطعات مورد نیاز از مسیرهای ملوانی و کولبری انجام نمی‌شود.');
  p.push("");
  p.push('🔸 احتمال لغو ممنوعیت واردات و صدور مجوز واردات چهار قلم لوازم خانگی تا سقف ۵۰۰ تا ۶۰۰ میلیون دلار وجود دارد.');
  p.push("");
